...
status = ["Sleeping", "Eating", "Gaming", "Anime Time", "Eating", "Snoring"]
...
async def displayembed():
  ...
  myEmbed.set_image(
    url="https://discordapp.com/assets/94db9c3c1eba8a38a1fcf4f223294185.png")
  myEmbed.set_thumbnail(
    url="https://discordapp.com/assets/f72fbed55baa5642d5a0348bab7d7226.png")
  myEmbed.set_author(
    name="Prodigy",
    icon_url=
    "https://discordapp.com/assets/e05ead6e6ebc08df9291738d0aa6986d.png")
...
async def help(ctx):
  ...
  helpEmbed.set_field(name=".yeet", value="Returns Yah!", inline=False)
